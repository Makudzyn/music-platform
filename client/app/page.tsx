  ...
  return (
    <ScrollWrapper>
      <div className="container flex max-w-screen-2xl flex-col px-4">
        ...
        <div className="container mx-auto px-4 pb-2">
          <Link href="/albums" className="mt-2 mb-1 flex w-full flex-row items-center px-4 pb-1 pt-1.5">
        ...
        <div className="container mx-auto px-4 pb-2">
          <Link href="/artists" className="mt-2 mb-1 flex w-full flex-row items-center px-4 pb-1 pt-1.5">
