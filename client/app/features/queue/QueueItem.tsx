...
export default function QueueItem({ track, index }: QueueItemProps) {
  ...
  return (
    <div className="grid grid-cols-[2rem,2.5rem,1fr] gap-3 items-center rounded-sm py-2 transition-all group/buttons hover:bg-primary/30">
      ...
      <div className="flex flex-col min-w-0 text-sm font-semibold leading-normal text-foreground mr-1.5">
        <Link href={`/tracks/${track._id}`} className="block group min-w-0">
