...
import { pause, play, setCurrentPosition, setCurrentTrack, setTotalDuration } from "@/app/features/player/playerSlice";

export default function Player() {
  const audioRef = useRef<HTMLAudioElement | null>(null);
  const dispatch = useAppDispatch();
  const {volume, currentTrack, repeatMode} = useAppSelector(state => state.player);
