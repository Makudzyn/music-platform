...
export class ArtistService {
  ...
  private async calculateArtistListens(
    ...
    artist.totalListens = tracks.reduce(
      (sum, track: Track) => sum + (track.listens || 0),
      0,
    );
